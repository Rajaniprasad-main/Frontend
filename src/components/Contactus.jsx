...
const ContactUs = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-800 font-sans">
      ...
      >
      <section className="flex flex-col items-center justify-center text-center py-2 px-2 animate-fadeIn">
        ...
        <div className="max-w-6xl mx-auto py-5 px-2 grid grid-cols-1 md:grid-cols-4 gap-6 ">
         {[
          {
