...
const Home = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100 text-center flex flex-col justify-center items-center">
      <h1 className="text-4xl md:text-5xl font-extrabold text-gray-800 mb-4 drop-shadow-sm">
        Welcome to <span className="text-gray-800">The University Hub</span>
      </h1>
      <p className="text-gray-800 text-lg md:text-xl mb-10 max-w-2xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl w-full px-4">
        <Link to="/colleges" className="bg-white border border-blue-200 shadow-sm rounded-xl px-6 py-8 text-gray-800 hover:bg-blue-50 transition group">
          <FontAwesomeIcon icon={faUniversity} size="2x" className="mb-4 text-gray-800 group-hover:scale-110 transition" />
          <h3 className="text-xl font-semibold mb-2">Explore Colleges</h3>
          <p className="text-sm text-gray-800">Browse the best institutions and programs tailored to your goals.</p>
        </Link>

        <Link to="/exams" className="bg-white border border-blue-200 shadow-sm rounded-xl px-6 py-8 text-gray-800 hover:bg-blue-50 transition group">
          <FontAwesomeIcon icon={faBookOpen} size="2x" className="mb-4 text-gray-800 group-hover:scale-110 transition" />
