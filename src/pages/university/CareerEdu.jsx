  ...
  return (
    <section className="text-center py-5 px-6">
      ...
      >
        ...
        <span className="font-semibold text-yellow-500">₹49</span> – affordable,
        personalized, and trusted.
      </motion.p>
      <motion.button
        whileHover={{ scale: 1.05 }}
        whileTap={{ scale: 0.95 }}
        className="px-8 py-3 rounded-xl bg-gradient-to-r from-gray-900 to-gray-900 text-yellow-500 font-semibold shadow-lg hover:shadow-xl transition"
      >
      ...
      <div className="bg-white rounded-2xl shadow-lg p-8">
        ...
        <div className="flex justify-between mt-6">
          ...
          {step === 7 && (
            <button
              onClick={() => setStep(8)}
              className="ml-auto px-6 py-2 bg-yellow-500 text-gray-900 font-semibold rounded-lg shadow hover:bg-yellow-500 transition"
            >
...
// Main Export
// -------------------
export default function CareerEdu() {
  return (
