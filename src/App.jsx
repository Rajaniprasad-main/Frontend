...
import HeaderBar from './pages/university/HeaderBar';
import MyProfile from './pages/university/MyProfile';
import MyCourse from './pages/university/MyCourse';
import Scholar from './pages/university/Scholar';
import StudyMt from './pages/university/StudyMt';
import ExamAt  from './pages/university/ExamAt';
import Setting from './pages/university/Setting';
